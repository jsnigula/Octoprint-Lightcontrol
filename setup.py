...
plugin_description = "Control LED strip."
plugin_author = "Jan Snigula"
plugin_author_email = "jsnigula@mac.com"
plugin_url = "None"
...
def params():
    ...
    # we might have additional data files in sub folders
    ...
    # If you have any package data that needs to be accessible on the
    # file system, such as templates or static assets
